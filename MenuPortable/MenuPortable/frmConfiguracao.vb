...
Public Class frmConfiguracao
    ...
    Private sConnectionString As String = String.Format("Data Source={0}\{1};Password={2};", Application.StartupPath, My.Settings.DataSource.ToString, My.Settings.password.ToString)
